...
size_t streamReplyWithRange(struct client *c, stream *s, streamID *start, streamID *end, size_t count, int rev, streamCG *group, streamConsumer *consumer, int flags, streamPropInfo *spi);
...
void streamPropagateConsumerCreation(struct client *c, robj *key, robj *groupname, sds consumername);
